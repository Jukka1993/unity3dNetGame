...
namespace general.script.logic
{
    class Room
    {
        ...
        {
            {//阵营1
                { 100f,2f,30f,4f,5f,6f},     //阵营1,1号出生点
                { 100f,2f,0f,4f,5f,6f},     //阵营1,2号出生点
                { 100f,2f,-30f,4f,5f,6f}      //阵营1,3号出生点
            },
            {//阵营2
                { -100f,2f,30f,4f,5f,6f},     //阵营2,1号出生点
                { -100f,2f,0f,4f,5f,6f},     //阵营2,2号出生点
                { -100f,2f,-30f,4f,5f,6f}      //阵营2,3号出生点
            }
        };
        public int roomId = 0;
